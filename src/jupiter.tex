...
que faz essas coisas". Tecnicamente, você não está errade: o \url{https://portalservicos.usp.br}
...
Basicamente porque os dois portais fazem a mesma coisa e por estarmos acostumades com o Júpiter,
...
bixes, ou não estarão matriculades nas disciplinas!}

Pode até parecer um monstro de 7 cabeças, mas está beeeeem longe disso!
Aproveitem esse momento para consultar aquelu veterane que você ama muito e que
...
requerimentos, também conhecidos como melhores amigos de alune da graduação,
são pedidos formais em que vocês inserem a matéria da qual vocês foram
chutades/negades/impedides de cursar e uma boa justificativa. Esse requerimento
vai para o coordenador do seu curso e possivelmente para o professor da
...
que até a P1 ou P2, vocês já devem saber se estão matriculades ou não.

Dica: Conversar com os coordenadores, es RDs e o professor responsável da disciplina
pode ajudar! Se vocês querem muito cursar uma matéria, não tenham vergonha de
lutar por ela :)

Além disso, desde 2020, es alunes de Bacharelado (todos os cursos menos a lic) usam
