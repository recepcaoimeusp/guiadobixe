...
\usepackage{float}
\usepackage{xurl}
\usepackage{adjustbox} % Para adicionar imagens aos títulos 
...
\usepackage{datatool} % Para tabela do editorial, permite ordenar os nomes em ordem alfabética
...
% Adiciona um nome a tabela de colaboradores do editorial
\newcommand{\addcolaborador}[1]{%
  \DTLnewrow{colaboradores}%
  \DTLnewdbentry{colaboradores}{nome}{#1}%
}
...
\begin{figure}[p]
  %\begin{center}
    %\hspace{1.7cm}
    \includegraphics[height=1\textheight]{img/capa2026.pdf} %REFTIME
  %\end{center}
\end{figure}
...
% iCEM - Iniação Científica para Computação, Estatística e Matemática ----------
\input{icem.tex}
