...
\begin{enumerate}
  \item Es veteranes têm sempre razão, exceto quando es bixes têm;
  \item Na hipótese de bixe ter razão, entra imediatamente em vigor
        o primeiro mandamento;
  \item Em qualquer evento social, as despesas correm sempre por conta des
        bixes, menos o que es veteranes consomem;
  \item Es bixes têm o direito de permanecerem calados (exceto quando
        interpelados por veteranes ou quando quiserem falar). Tudo o que elus
        disserem pode ser usado contra elus, \textit{c’est la vie};
  \item Es bixes devem se apresentar imediatamente em caso de convocação por
        veteranes, a não ser que estejam fazendo algo melhor da vida. Es bixes
  ...
  \item Es bixes devem estar prontos para assumirem as seguintes funções para
        veteranes: completar mesa de jogo, companhia de bandejão, completar
        time(s) etc., mas somente quando tiverem vontade;
  \item Es bixes devem amar e respeitar seus veteranes, a vida, as plantas,
  ...
  \item Todes es bixes estão despreparades, exceto os que leram isto.
\end{enumerate}
...
Comissão de Recepção 2026 %REFTIME
via mala direta e serão imediatamente incineradas. Uma parte des veteranes sugeriram
