...
do que fazemos! E se isso não te animou, também temos corujões e mesas de
\textit{RPG} de vez em quando, abertas para membros e não membros!

Interessades? Vejam nossos jogos nos links abaixo ou entrem no nosso servidor
de Discord para mais informações!

\textbf{Inclusive, para participar, basta se apresentar no servidor.} 
Ser um membro não é lá muito formal, a gente bate um papo e vê o que seria legal
  para você fazer. O grupo é horizontal e cada um escolhe o quanto participa.

\begin{description}
  \item[Nosso site:] \url{https://usp.game.dev.br/}
  \item[Página com nossos jogos:] \url{https://uspgamedev.itch.io/}
  \item[Servidor de Discord:] \url{https://discord.gg/agZv7zu}
  \item[E-mail:] {\tt contato@usp.game.dev.org}
  \item[Instagram:] \url{https://instagram.com/uspgamedev/}
\end{description}
