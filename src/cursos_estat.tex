...
\begin{itemize}
    ...
    algumas dinâmicas bem inusitadas para avaliar es alunes;
...
disciplinas está no catálogo de graduação, disponibilizado no site do IME). 
A vantagem é que você não precisa de tempo extra, já que essas disciplinas podem 
ser aproveitadas dentro da carga horária de optativas eletivas e livres que 
você já precisa cumprir. Aqui estão mais alguns detalhes das áreas:
...
e PUC. Es alunes frequentemente travam em matérias de exatas, especialmente 
...
especialmente no mercado financeiro e de seguros. E a melhor parte? Muites 
