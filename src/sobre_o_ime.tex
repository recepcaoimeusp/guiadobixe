...
Computação não faz parte da sigla mesmo! Aliás, faz sim, mas só es inteligentes
...
confusão toda, até algumes veteranes insistem em dizer que só existem os blocos
A, B e C.
...
\item {\bf IME Jr:} é a empresa júnior do IME, que é administrada peles própries
alunes da graduação. Fica na sala 258A.
...
vocês! Essa sala só pode ser usada por alunes da pós-graduação e por algumes
alunes que fazem iniciação científica.

\item {\bf Rede Linux:} rede de computadores que podem ser usados por alunes
da graduação (ieiii!). Utilizam o Linux, que, ao contrário do Windows, é um
Sistema Operacional. Tode alune que fizer uma conta, possui 75 cotas de impressão por mês 
(imprimir de graça).
...
Aí cabe a vocês, bixes, ficarem atentes às datas divulgadas pelo CAMat e demonstrarem 
...
\item {\bf CAEM:} sigla para o Centro de Aperfeiçoamento do Ensino da
  ...
  presta serviços de assessoria para professores de Matemática. Quem faz
  Licenciatura (futures professories) também pode usufruir dos serviços do CAEM,
  e até mesmo estagiar lá. Fica no 1º andar do bloco B, em frente às escadas.
...
docentes, alunes devem ser anunciados ou apresentarem uma boa desculpa para
...
Ê alune de graduação poderá pedir emprestado 10 livros por 10 dias. Para o empréstimo é necessário cadastrar uma senha pessoalmente e apresentar qualquer um dos seguintes documentos: cartão provisório, carteirinha USP, aplicativo e-card ou RG/CNH. Poderão ser feitas 3 renovações pela internet (DEDALUS) e 3 reservas de livros que estiverem emprestados com outres alunes. O atraso na devolução gera suspensão (nº livros atrasados multiplicado pelo nº dias em atraso). 
\end{subsubsecao}
