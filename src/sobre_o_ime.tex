...
Em algum momento da graduação (ou em muitos momentos), você vai acabar passando bastante tempo na Biblioteca Carlos Benjamin de Lyra. Seja para estudar antes das provas, procurar um livro específico, fazer trabalhos ou simplesmente achar um canto mais silencioso para se concentrar. A biblioteca faz parte da Agência de Bibliotecas e Coleções Digitais (ABCD) da USP e é referência na área, sendo considerada uma das melhores bibliotecas de matemática da América Latina. Seu acervo é enorme: são cerca de 235.000 itens, entre livros didáticos, revistas acadêmicas, teses, relatórios e até materiais multimídia, como CDs e DVDs.
...
Se vocês acham que o IME é só sala de aula e prova, estão muito enganados. O IME é um centro de referência mundial em produção de conhecimento, e quem organiza esse "circo" da descoberta é a CPqI. A Comissão de Pesquisa e Inovação é responsável por traçar diretrizes, fomentar a pesquisa e zelar pelas boas práticas científicas dentro do instituto.

Basicamente, é aqui que vocês vão procurar sarna para se coçar (no bom sentido) se quiserem ir além da graduação padrão e entrar no mundo da pesquisa acadêmica.
