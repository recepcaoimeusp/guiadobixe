...
Mas uma nova resolução dividiu essas 200 horas em dois blocos de 100 horas.

O blocos são Bloco I - Atividades Extensionistas e Bloco II - Atividades Diversas.
É importante não ficar perdido! Não existem atividades que contem para os dois blocos
ao mesmo tempo então é essencial saber se alcançou as 100 horas em cada Bloco.

Vocês podem conferir quais as atividades que contam como horas complementares,
e quais delas se encaixam em cada bloco,
no seguinte link: \url{https://www.ime.usp.br/lm/} (atenção: há arquivos para ingressantes
de diferentes anos nesse site, se você ingressou esse ano, o arquivo certo é para os
ingresssantes a partir de 2023, se não é o seu caso, confira o que melhor se adequa).
...
para contar como horas de ATPAs. Nessa disciplina você entregará as horas de ambos os blocos.
\textbf{Apenas se matricule nessa disciplina caso já}
\textbf{tenha acumulado as 100 horas em cada bloco ou esteja muito perto de completar.}
