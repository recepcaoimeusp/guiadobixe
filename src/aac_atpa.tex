...
Outra coisa, existem atividades específicas que contam como horas
...
Contudo, houve mudança para os ingressantes desde de 2023, essas 200 horas 
são agora dividas em 2 blocos e é necessário cumprir 100 horas em cada bloco.

Em relação a esses 2 blocos, atualmente eles estão divididos em:
Bloco I - Atividades Extensionistas e Bloco II - Atividades Diversas.
Cada bloco tem tipos de atividades que são exclusivas dele, não dá pra fazer
uma atividade que acumule horas para os dois blocos, mas não é hora do desespero!
Comece a fazer as atividades com antecedência e quando for se matricular na matéria,
observe se está perto de bater a meta de 100 horas em cada um dos blocos.

A realização dessas horas é obrigatória após uma reforma nas licenciaturas
realizada pelo MEC e que foi implementada na USP em 2006. E a divisão
dela em blocos foi acrescentada recentemente, implementada somente agora em 2026.

Vocês podem conferir quais as atividades servem para as ATPAs e
quais se encaixam dentro de cada bloco no seguinte link: 
\url{https://www.ime.usp.br/lm/} (atenção: há um arquivo para
ingressantes de até 2015, outro para ingressantes a partir de 2016 e um outro para
ingressantes a partir de 2023, que é o seu caso se você ingressou esse ano, então
...
para contar como horas de ATPAs. Nessa disciplina, é onde você irá entregar as atividades
dos dois blocos. \textbf{Apenas se matricule nessa disciplina caso já}
\textbf{tenha acumulado as 100 horas em cada bloco das ATPAs ou esteja muito perto de completar.}
...
no seguinte link: \url{https://www.ime.usp.br/graduacao/atividades-academicas-complementares/}.
