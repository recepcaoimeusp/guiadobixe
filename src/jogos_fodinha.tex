...
de cartas é a mesma, sendo que a ordem, da mais fraca para a mais forte, é a seguinte:

\begin{center}
\textbf{4 5 6 7 Q J K A 2 3}
\end{center}

Além disso, existe uma manilha (se você não sabe o que é,
...
manilhas, existe uma hierarquia de naipe:
...
A carta de paus é a mais
forte, seguida da de copas, espadas e ouros.
...
saiu naquela rodada, as duas se cancelam e saem da disputa (uma carta "\textit{mela}" a outra), mesmo que sejam as
