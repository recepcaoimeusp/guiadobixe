...
\begin{subsecao}{Hardware Livre \adjincludegraphics[height=5ex, valign=m]{img/Lápide.png}}

\figurapequenainline{logo hardware livre}

(O Hardware Livre USP está atualmente inativo, cabe aos bixes interessados trazer 
o grupo à ativa novamente se tiverem interesse!)
