...
Não se esqueça de contribuir com sua prova ao final do semestre encaminhando uma foto ou o PDF da prova via email do CAMat (camat@ime.usp.br), não
...
Chá Mate é o encontro mensal, no estilo roda de conversa, que o CAMat organiza para es estudantos debaterem temas
ligados a política e a vida universitária do momento. Desde a criação do Chá Mate, já discutiu-se
...
experiência universitária, alguma reflexão de vida que teve, ou uma produção artística sua. Você pode conferir a última edição do BoletIME em formato 
...
especial do CinIME.
Também é quando você pode comprar o já tradicional Kit Otaku contendoitens temáticos, além dos bottons exclusivos do evento.
