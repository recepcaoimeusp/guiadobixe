...
\vspace{-15pt}
  ...
  gasolina, venham para a USP de carro e, obrigatoriamente, deem carona a ume
  veterane;
...
\begin{enumerate}
  ...
  \item Vocês são super sortudes e acharam um ônibus que vai de casa pra USP.
\end{enumerate}
\vspace{-15pt}
...
atentes para não se perderem, hein?
...
Essas linhas funcionam dentro da USP, e nós alunes não pagamos, pois elas
...
Para es bixes que não gostam de ler (preferem imagens) colocamos o
...
Como sabemos que vocês, bixes, chegam muito perdides, e muites pularam todas
