...
%REFTIME
\textbf{IMPORTANTE:} as informações a seguir referentes ao Restaurante do IPEN, 
Lanchonete da FAU e Poke da Reitoria não estão atualizadas com os preçoes referentes à 
2023. Então interprete onde estiver escrito ``custa R\$ $x$'' como ``vai custar um 
tanto a mais que R\$ $x$''.
