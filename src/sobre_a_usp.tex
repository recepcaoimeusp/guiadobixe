...
Abaixo dele vêm as coordenadorias e unidades. A PRIP (Pró-Reitoria de Inclusão e Pertencimento),
...
\begin{subsecao}{A PRIP}

A Pró-Reitoria de Inclusão e Pertencimento (PRIP), que fica próxima à Praça do
Relógio, é o órgão da USP responsável por acolher a diversidade, assegurar oportunidades
e oferecer condições para permanência dos alunos — não é lá a melhor coisa 
do mundo, mas ajuda... É onde vocês podem conseguir seus benefícios, tais como 
auxílios financeiros, moradia gratuita (CRUSP), auxílio alimentação ou dentistas gratuitos.
A PRIP também é responsável pelo Setor de Passes Escolares.
...
deverão ser feitas dentro dos prazos estipulados no EDITAL PAPFE 2026, que pode 
ser encontrado na página da PRIP (\url{https://prip.usp.br/wp-content/uploads/sites/1632/2025/12/PAPFE2026_EDITAL.pdf}).
No Júpiter \url{https://uspdigital.usp.br/jupiterweb/}, vocês entrarão 
...
no valor de 885 reais, ou a vaga no alojamento (CRUSP), acompanhada de um auxílio de 335 reais. Como 
...
A USP Butantã conta com uma clínica odontológica para população USPiana, e isso inclui,
é claro, os alunes. Para ser atendido, você precisa ir até a clínica, no bloco G do CRUSP,
e fazer seu agendamento, sendo que em casos emergenciais eles podem fazer o atendimento
no mesmo momento. Consulte mais informações no site: (\url{https://sau.usp.br/clinica-odontologica/horario-de-atendimento/}).

Algumas vezes pode ser demorado, principalmente no período de aulas, já que é uma clínica 
pequena considerando o tamanho da USP e a quantidade de alunos, no entanto, é um serviço
gratuito e que realmente ajuda.

%FIXME
\textbf{Setor de passe escolar}

Será nesse lugar que você resolverá boa parte dos seus problemas com a PRIP e com o
...
Vocês também podem entrar nos sites das empresas de transporte e procurar por mais informações lá.

Há também descontos para alunos de universidades públicas provenientes
de outras cidades do interior de São Paulo. Se algum de vocês vem de algum desses lugares
desconhecidos (como Resende, Caçapava ou Guaíra), pode se dirigir ao site da sua empresa de
transporte intermunicipal (Cometa, Danúbio Azul, Pássaro Marron etc.), ver como funciona o
processo (normalmente respondendo um formulário), esperar aprovação do seu instituto, e então
receber um documento que permite a compra de passagens por 50\% do valor normal. Existem
empresas que tem um período específico para requisição do cartão, então é melhor se apressar!
...
funciona na terça-feira às 16h, no IP, e para ser atendido é necessário
fazer um agendamento de horário à partir das 9h30.
...
previamente, no período indicado no site. Atualmente o projeto está fechado
por conta do grande número de pessoas para serem atendidas, no entanto,  fique
atento que logo eles podem abrir novas vagas!
...
Os bandejões são os lugares em que vocês podem se alimentar razoavelmente a um preço analogamente razoável.
...
opção deixou de funcionar. É possível verificar o saldo atual e comprar 
...
O cardápio semanal do bandejão pode ser visto no site
\url{http://sites.usp.br/sas/} ou pelo aplicativo ``Cardápio+ USP'', mas se vocês
...
O cardápio é geralmente composto de arroz (com opção normal ou integral), feijão,
prato principal (carne/opção vegetariana), acompanhamento (legumes ou verduras refogadas,
cremes, molhos), salada (algumas folhas), sobremesa (frutas e/ou, às vezes, algo mais
requintado), pãozinho (normal ou integral) e suco (de diversos sabores: azul, vermelho,
amarelo, etc.), além de temperos genéricos (jamais perguntem do que eles são feitos). 
Se vocês são vegetarianos, todos os bandejões têm uma alternativa vegetariana 
(e estão tentando fazer com que sejam veganas também) de PVT para o prato principal, 
normalmente vindo na forma de ração, podendo também aparecer como escondidinho, lasanha, 
kibe e outros (vale a pena experimentar o escondidinho da Central).
...
%\end{center}
%\end{figure}
% As informações estão bem desatualizadas e não deu tempo de gerar outra imagem

O horário de funcionamento dos bandejões é o seguinte:\\
\textbf{Café da manhã:} 7h às 8h30 (somente no Central e na Pref, de segunda à sexta),
7h30 às 9h (somente na Química de sábado) e 8h30 às 9h30 (somente na Química de domingo)\\
\textbf{Almoço:} 11h15 às 14h15 (em todos os bandejões de segunda à sexta,
de sábado e domingo somente na Química)\\
\textbf{Jantar:} 17h30 às 19h45 (somente na Química, na Física e no Central de segunda à sexta)
e 17h30 às 19h (somente na Química de sábado)\\
...
Para mais informações, visitem o site da PRIP: \url{https://prip.usp.br/servicos/alimentacao/} ou
utilizem o aplicativo ``Cardápio+ USP''.

\end{subsecao}

\begin{subsecao}{Raia Olímpica: história, versatilidade e inclusão}

A Raia Olímpica da Cidade Universitária (USP) foi inaugurada em 1973, fruto de uma grande obra 
de engenharia que retificou um trecho do Rio Pinheiros. Ela foi concebida originalmente para sediar 
as provas de remo e canoagem dos Jogos Pan-Americanos de São Paulo, em 1975.

Hoje, a Raia é um complexo náutico de referência com dimensões olímpicas (aproximadamente 2.200 metros 
de extensão por 100 metros de largura) e águas tratadas. Além de ser um cenário esportivo, o local também 
é famoso por ser o habitat de uma simpática população de \textbf{capivaras}, que circulam livremente pelas margens 
e já se tornaram um símbolo do lugar.

Sua utilização se expandiu significativamente: além do tradicional \textbf{remo olímpico} e da 
\textbf{canoagem velocidade}, o espaço agora abarca modalidades como o \textbf{Stand Up Paddle (SUP)} 
e a \textbf{Canoa Polinésia (Va'a)}, tendo inclusive potencial para receber campeonatos de polo aquático.

A infraestrutura é robusta, contando com hangares para barcos de competição e salas de ginástica com remos 
ergômetros. Um destaque essencial para o ensino é o \textbf{"barco escola"}, um simulador fixo de concreto (tanque de remo) 
que permite aos iniciantes aprenderem a técnica correta das remadas com estabilidade antes de enfrentarem a água.

Além de abrigar as atividades do CEPEUSP e as sedes náuticas de clubes como \textbf{Pinheiros, Paulistano, Corinthians e 
Bandeirantes}, a Raia é um palco central de eventos. Ela sedia regularmente campeonatos nacionais e internacionais 
de remo e canoagem, e é famosa por receber eventos de grande porte de outras modalidades, como a etapa de natação 
da prova de triatlo \textbf{Ironman}, realizada ali diversas vezes.

O espaço mantém um papel social vital através de iniciativas transformadoras. Destacam-se o \textbf{"Remo Meu Rumo"}, 
que utiliza o remo e a canoagem adaptados para promover a inclusão e o desenvolvimento integral (físico, 
psíquico e social) de crianças e adolescentes com deficiência, e o \textbf{"Remama"}, projeto que utiliza o remo na 
reabilitação física e emocional de mulheres sobreviventes do câncer de mama.
...
%REFTIME
\textbf{Importante:} as informações referentes a valores não estão exatamente atualizadas com
os preços vigentes em 2026. Interpretem onde estiver escrito ``custa R\$ $x$'' 
...
69,00 o quilo, sempre tem uma razoável quantidade de saladas e pratos
...
12,50 (4 unidades). Vocês vão sentir o cheiro MARAVILHOSO dos cookies quando forem bandejar.
...
preço deles costuma ser no máximo R\$12,00.
...
\textbf{Fresco & Natural da ECA}

O food truck fica em frente ao CAC, na ECA, no final da rua da reitoria. Lá vendem saladas, 
açaís, sucos, crepes, lanches, massas, waffles. Tem como preço mínimo R\$15,00 pelo waffle e 
preço máximo R\$35,90 o sanduíche, o restante varia entre esses valores. Além da 
variedade de coisas, o lugar é super gostoso de ficar, tem umas mesinhas, é ao ar livre e o 
atendimento é muito receptivo.

Instagram do local: \url{https://www.instagram.com/frescoenaturalsp?igsh=d3Yxd2hxZmd2NGNw}

\textbf{Lanchonete Caju}

Fica ao lado da FFLCH e em frente à FAU. É uma ótima opção para quem está cansado da comida
\sout{questionável} do bandejão. Lá vendem salgados e pratos feitos, como o maravilhoso macarrão com frango
(prato do dia às quintas-feiras), que custam por volta de R\$28,00. Muitos professores costumam
almoçar por lá também, então esteja preparado emocionalmente para encontrar seu professor
favorito \sout{ou que mais odeia}.

Instagram do local: \url{https://www.instagram.com/lanchonetecaju/}
