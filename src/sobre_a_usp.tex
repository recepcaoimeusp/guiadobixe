...
que vocês, simples bixes IMEanes, sejam capazes de se imaginar fazendo. Por este e-mail
...
comunicação (às vezes a única) entre nós alunes e todos os outros grupos, pessoas,
...
Além disso, peçam para es veteranes falarem mais um pouco de algumas 
...
vale a pena juntar seus amigues para criar os grupos no começo do semestre e espalhar
para es outres alunes.
...
\item Tirar dúvidas sobre a matéria com es coleguinhas.
\end{enumerate}
...
universidades (inclusive a USP). Mesmo que você seja apenas alune da USP, se viajar
...
\sout{ninguém entende, mas se algume de vocês entender,} estão no site
...
Se algume de vocês, bixes, estudou a vida inteira em escola pública, tem baixa renda,
ou está passando por algum tipo de vulnerabilidade social, não pense que está sozinho nessa,
muites também passaram por isso e vocês conseguem encontrar apoio aqui. Permanência
...
As inscrições des ingressantes para o Programa de Apoio à Permanência e Formação Estudantil (PAPFE)
...
Vale ressaltar, bixes, que vocês tomem o cuidado de não fazer o mesmo que algumes
...
Caso você seja selecionade em qualquer uma dessas modalidades, recebe também o auxílio alimentação, que se trata de créditos
...
Há também um cartão especial para alunes de universidades públicas provenientes
de outras cidades do interior de São Paulo. Se algume de vocês vem de algum desses domos
...
aes alunes, cada um com um foco e um público-alvo. Dentre eles, destaca-se
...
estiverem com preguiça de ver em um desses lugares, é bem provável que ume veterane 
já saiba e resolva informar, se questionade com muita educação.
...
Se vocês são vegetarianes, o acompanhamento nunca contém carne (e estão tentando 
...
principalmente nos feriados, por isso recomendamos que vocês fiquem atentes ao 
...
Além disso, no terceiro andar da FAU tem a mesinha de doces que es alunes deixam lá
