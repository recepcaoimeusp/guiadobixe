...
% Em 2020: https://ime.usp.br/~kazuo/guiadobixo.pdf
  \begin{center}
    \includegraphics[width=0.22\textwidth]{img/qrcodeguia2025.jpeg}
  \end{center}
  \vspace{-20pt}
...
{\large\bf Colaboradores 2026} \\
Quem ajudou na construção do guia esse ano

% Criando o banco de dados
\DTLnewdb{colaboradores}

\addcolaborador{André}
\addcolaborador{Caio}
\addcolaborador{Escobar}
\addcolaborador{Letícia Moribe}
\addcolaborador{Mariana}
\addcolaborador{Thalia}
\addcolaborador{Andy}
\addcolaborador{Analice}
\addcolaborador{Ana}
\addcolaborador{Arthur}
\addcolaborador{Carol (Carolina)}
\addcolaborador{Cindy}
\addcolaborador{Clayton}
\addcolaborador{Davi}
\addcolaborador{Eduardo Yukio}
\addcolaborador{Gabriel}
\addcolaborador{Gabriel Graciano}
\addcolaborador{Guilherme Leite}
\addcolaborador{Gustavo}
\addcolaborador{Henrique}
\addcolaborador{Julia}
\addcolaborador{Kevin}
\addcolaborador{Letícia dos Santos}
\addcolaborador{Lucas Rabaquim}
\addcolaborador{Lucas Joia}
\addcolaborador{Lucas Antônio}
\addcolaborador{Lucas Toshioka}
\addcolaborador{Manuella}
\addcolaborador{Miguel}
\addcolaborador{Murilo}
\addcolaborador{Pedro}
\addcolaborador{Raissa}
\addcolaborador{Guilherme Rinaldi}

% Ordenação automática
\DTLsort{nome}{colaboradores}

% Construção da tabela (lógica para evitar o erro de 'alignment tab')
\newcounter{colcount}
\newcommand{\corpoTabela}{} % Variável que vai guardar o texto da tabela

\DTLforeach*{colaboradores}{\Nome=nome}{%
    \stepcounter{colcount}%
    % Adiciona o nome à variável
    \xappto\corpoTabela{\Nome}% 
    \ifnum\value{colcount}=3
        \gappto\corpoTabela{\\}% Se for o 3º, quebra a linha
        \setcounter{colcount}{0}%
    \else
        \gappto\corpoTabela{&}% Se não, coloca o separador de coluna
    \fi
}

{
\renewcommand{\arraystretch}{1.4}% Controla o espaçamento verical entre os nomes

\begin{center}
    \begin{tabular}{llll} % 3 colunas
        \corpoTabela % Aqui o LaTeX apenas imprime o que foi montado acima
    \end{tabular}
\end{center}
}
