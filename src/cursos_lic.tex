...
Não só por terem sido aprovados na USP, mas também por terem entrado na
...
Sabiam que é possível trabalhar na produção de diversos materiais didáticos ou também
...
Um bacharel tem uma formação mais voltada para a pesquisa em Matemática e para suas aplicações. 
Portanto, usa a Matemática explorando problemas em aberto, na esperança de solucionar alguns deles e,
consequentemente, criar outros mais, além de poder atuar em áreas técnicas e aplicadas fora do ambiente
acadêmico.
...
podem ter tido bons professories. Inspirem-se neles e os superem. Durante seus 
próximos ``n'' anos aqui na faculdade, vocês aprofundarão seus conhecimentos em 
temas que viram na escola e terão oportunidades de melhorar as práticas de ensino.
...
que aprofundem seus conhecimentos. APROVEITEM!
...
Faculdade de Educação, que irá prepará-les melhor nesse contexto (ou, pelo
...
\item O tão difícil ``meio-termo''... É um ideal difícil de ser conquistado; afinal,
  ...
  dos professories por se formarem de um a três anos a mais e ainda
