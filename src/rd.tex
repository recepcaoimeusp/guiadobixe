...
docente, enfim, coisas desse tipo. Além disso, cada cargo de RD possui também um suplente.
Nas eleições, os estudantes votam em uma chapa composta pelo representante discente titular 
e seu respectivo suplente, que assume o cargo em caso de impedimento ou ausência do titular ao longo do mandato.

Dá para perceber o quanto é importante ter estudantes em cada um desses conselhos 
...
muito importante ter um aluno em cada um desses conselhos. A quantidade de votos recebidos 
por uma chapa também é importante, pois demonstra para a administração do instituto o nível 
de confiança que os estudantes depositam naquele representante para defender seus interesses. 
Um maior número de votos fortalece a legitimidade da atuação dos RDs dentro dos conselhos 
e comissões. Se estiverem tendo problemas com professores, requerimentos etc., ou simplesmente quiserem saber o que anda acontecendo, procurem o RD certo pra conversar. Perguntem,
...
disponíveis). Quando a eleição estiver se aproximando, vocês receberão (vários) e-mails com os documentos necessários, prazos e links de votação.
