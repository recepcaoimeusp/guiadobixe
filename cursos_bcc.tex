...
fazer estágios de verdade antes do 3º ano, por causa das aulas do período da 
tarde. Então aproveitem o curso! Preocupem-se em trabalhar quando tiverem 
mais tempo ``livre''.
...
Outro site que vocês devem ver é o \url{https://aurora.ime.usp.br}, um site 
interativo para organizar sua grade horária: adicionar matérias que você já 
cursou e ver quais são as matérias obrigatórias, optativas e das trilhas 
(já já falaremos das trilhas). Além disso, mostra quantos créditos faltam de 
optativas e obrigatórias, e quais são os requisitos para cursá-las de forma 
bem simples e intuitiva. Vale a pena conferir!
...
que tem um pouco de Cálculo III e Cálculo IV, apelidado de Cálculo $\pi$.
...
Muites dizem que toda essa maratona de Matemática foi inventada para 
torturá-les. Elus estão certes. Mas além disso, ela serve para dar uma boa 
``base'' em Matemática, já que toda a teoria da Computação faz uso dela e, 
como futures possíveis pesquisadories, vocês precisam estar preparades para 
utilizá-la. Além disso, dizem que a Matemática desenvolve um raciocínio lógico 
...
preocupem, vocês terão algumas matérias mão na massa, ou mão no teclado, 
durante esses primeiros anos também.

Outra coisa importantíssima sobre nosso curso é a liberdade que ele dá:
...
liberdade no curso quanto à escolha de optativas é bem grande; vocês
...
ênfases em distintas áreas da computação, que são possíveis caminhos para vocês 
seguirem no curso. Essas trilhas foram criadas para agrupar as matérias de uma 
área e ajudar alunes a escolherem as optativas dos assuntos que querem estudar 
mais. Atualmente há quatro: \textbf{Teoria da Computação}, 
\textbf{Sistemas de Software}, \textbf{Inteligência Artificial} e 
\textbf{Ciência de Dados}, que estão brevemente explicadas em 
\url{https://bcc.ime.usp.br/trilhas/}.

Mas não se preocupe se você não gostou de nenhuma, já que não é obrigatório 
...
alguma e completá-la, isso será um bom destaque para entrevistas de emprego.
...
programação e pode aplicar esse conhecimento para dominar rapidamente 
\textbf{toda} e \textbf{qualquer} linguagem, tecnologia etc. O BCC não é um 
curso que ensina $N$ linguagens (na verdade, $N = 4$ ou $5$, dependendo da boa 
vontade dos professores) e como usar $M$ programas e recursos. O BCC é um curso 
que ensina a técnica e a teoria que lhe darão uma base sólida para você 
aprender qualquer coisa. E essas coisas que são ensinadas vão te ajudar 
bastante a entender tudo.

Finalmente, esteja sempre atente aos eventos promovidos pela IME Jr 
(a Empresa Júnior do IME), CAMat, grupos de extensão e pelo próprio instituto, 
que ajudarão a complementar sua formação e a cumprir horas complementares. 
Boa sorte, pois você vai precisar, a jornada é longa e às vezes tortuosa, mas 
você verá que valerá bastante a pena. \textbf{Use Linux, aprenda Git} e 
memorize esta mensagem: \texttt{Segmentation Fault}. Ela será uma assombração 
